      ...
      <SheetContent side="left" className="w-[85vw] max-w-sm bg-black/60 backdrop-blur-sm text-white p-0">
        <ScrollArea className="h-full w-full p-4 [--scroll-bar-display:none]">
          <div className="mt-8 mb-6 flex items-center gap-3">
            <Image src="https://firebasestorage.googleapis.com/v0/b/verdant-market-x1qp8.firebasestorage.app/o/documentacoes_circuito%2FLogo_Circuito.png?alt=media&token=9b122ad7-4dbf-46c3-a91c-19b5ff1210ef" alt="Logo Circuito Carioca" width={60} height={60} className="rounded-full" />
            <div>
              <h1 className="text-lg font-bold tracking-wider text-white">GALERIA ORGÂNICA</h1>
              <span className="block text-[10px] font-normal tracking-normal">CIRCUITO CARIOCA DE FEIRAS ORGÂNICAS</span>
            </div>
          </div>
